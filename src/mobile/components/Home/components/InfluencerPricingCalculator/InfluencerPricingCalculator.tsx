...
const InfluencerPricingCalculator = () => {
  ...
  React.useEffect(() => {
    if (state && state.scrollTo === "target" && targetRef.current) {
      window.scrollBy({ top: 2320, behavior: "smooth" });
  ...
  return (
    <S.Container ref={targetRef}>
      ...
      >
          ...
          >
            <MenuItem
              ...
              sx={{
                ...
                padding: "0px 8px",
                minHeight: "30px", // Optional: Change the placeholder text color
              }}
            >
              Select Your Niche
            </MenuItem>
        ...
        <S.FieldContainer>
          <S.Label>
            Engagement Rate <S.LabelVal>{engagementRateValue}%</S.LabelVal>
          </S.Label>
          <Slider
            style={{ color: "#787880" }}
